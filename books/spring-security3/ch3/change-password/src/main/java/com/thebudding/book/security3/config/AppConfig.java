...
import com.thebudding.book.security3.service.InMemoryChangePasswordDaoImpl;
...
public class AppConfig {
  ...
  @Bean
  public InMemoryChangePasswordDaoImpl userService() {
    Properties properties = new Properties();
    properties.setProperty("guest", "guest,ROLE_USER");

    InMemoryChangePasswordDaoImpl userService = new InMemoryChangePasswordDaoImpl();
    userService.setUserProperties(properties);
